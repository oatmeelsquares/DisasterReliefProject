...
```{r figure-X-lda-cm, output = TRUE}
#| fig.align: center
#| out.width: 70%
#| fig.cap: True positives are fairly high. False negatives are fairly low, while also limiting the number of false positives.
#| dev: "png"
#| dpi: 100
lda_cm
```
