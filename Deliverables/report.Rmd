...
knnp1 <- 13452/(13452+31424) #KNN
ldap1 <- 13860/(13860+63633) #LDA
qdap1 <- 13586/(13586+71822) #QDA
logp1 <- 14479/(14479+193475) #Log
penp1 <- 14480/(14480+206144) #Pen
ensp1 <- 13863/(13863+64505) #Ens
svmlp1 <-  14478/(14478+204855) #SVML
svmpp1 <- 14480/(14480+101993) #SVMP
svmrp1 <- 14480/(14480+170042) #SVMR

# precision calculations for holdout performance
knnp2 <- 1999/(1999+291) #KNN
ldap2 <- 1791/(1791+1284) #LDA
qdap2 <- 2017/(2017+1732) #QDA
logp2 <- 1974/(1974+786) #Log
penp2 <- 1990/(1990+961) #Pen
ensp2 <- 2017/(2017+626) #Ens
svmlp2 <- 1968/(1968+851) #SVML
svmpp2 <- 2018/(2018+635) #SVMP
svmrp2 <- 2014/(2014+781) #SVMR
